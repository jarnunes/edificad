--pass: 123
insert into eds_user (id, create_date, create_user, last_modified_date, last_modified_user, email, enabled, full_name, locked, password, username)
...
values ((SELECT NEXTVAL('seq_role_user')), current_timestamp, 'system', current_timestamp, null, 'ADMIN', 0);

insert into eds_role_user (id, create_date, create_user, last_modified_date, last_modified_user, role, user_id)
values ((SELECT NEXTVAL('seq_role_user')), current_timestamp, 'system', current_timestamp, null, 'WEBSERVICES', 0);


insert into eds_role_user (id, create_date, create_user, last_modified_date, last_modified_user, role, user_id)
values ((SELECT NEXTVAL('seq_role_user')), current_timestamp, 'system', current_timestamp, null, 'OPERATOR', 1);

insert into eds_role_user (id, create_date, create_user, last_modified_date, last_modified_user, role, user_id)
values ((SELECT NEXTVAL('seq_role_user')), current_timestamp, 'system', current_timestamp, null, 'WEBSERVICES', 1);
