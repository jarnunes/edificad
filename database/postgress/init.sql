...
insert into eds_role_user (id, create_date, create_user, last_modified_date, last_modified_user, role, user_id)
values ((SELECT NEXTVAL('eds_role_user_seq')), current_timestamp, 'system', current_timestamp, null, 'OPERATOR', 1);

insert into eds_role_user (id, create_date, create_user, last_modified_date, last_modified_user, role, user_id)
values ((SELECT NEXTVAL('eds_role_user_seq')), current_timestamp, 'system', current_timestamp, null, 'WEBSERVICES', 1);
